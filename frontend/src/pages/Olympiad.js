    ...
    <div>
      ...
      >
        ...
        <div className="md:grid md:grid-cols-2">
          <div>
            <img src={im3} alt="" className="md:h-[27rem] h-[20rem] mt-8 mb-4 mx-auto"></img>
            <div>
              <h1 className="md:mt-12 mt-3 md:ml-20 ml-4 text-white text-2xl md:text-4xl font-bold">
                Gravity Brain National Olympiad (GBNO)
              </h1>
              <p className="md:ml-20 ml-4 text-white text-xl md:text-3xl font-semibold mt-3">
                India's Leading Aptitude Test for
              </p>
              <p className="text-xl px-2 py-4 w-32 text-center rounded-xl bg-amber-500 mt-2 font-semibold md:ml-20 ml-4 ">
                Grade 3-10
              </p>
              <p className="text-xl px-2 py-4 w-80 text-center rounded-xl bg-amber-500 mt-2 font-semibold md:ml-20 ml-4">
                Scholarships worth Rs. 2.5 Cr.
              </p>
              <p className="md:ml-20 ml-4 mt-4 text-white text-lg mb-4 md:text-xl">
          ...
          <div>
            <form className="px-8  py-8 bg-white  mx-3 md:mx-0 md:w-4/5 rounded-xl">
              <h1 className="font-bold text-3xl">
                Enroll for Scholarships Now!
              </h1>
              <div className="flex">
                <input
                  className="bg-gray-200 rounded-md outline-none py-4 px-4 mt-4 placeholder-slate-800 w-full "
                  type="text"
                  placeholder="First Name"
                  required
                ></input>
                <input
                  className="bg-gray-200 rounded-md outline-none py-4 px-4 mt-4 placeholder-slate-800 w-full ml-4 "
                  type="text"
            ...
            <button className='py-4 px-10 bg-gray-500 text-white mt-4 rounded-xl text-xl'>APPLY NOW</button>
            </form>
          </div>
        </div>
      </div>
      <div>
      <div className="mt-12 mx-2 md:mx-52">
      ...
      <div>
        <h1 className='text-center text-4xl font-bold mt-16 md:mt-36'>About <span className='text-blue-600'>Gravity</span> Brain National <span className='text-blue-600'>Olympiad</span></h1>
        <div className='md:grid md:grid-cols-3  md:mx-20 mx-2 space-y-4  md:space-y-0 mb-4 gap-8 mt-8 text-center '>
        ...
        <div className='md:grid md:grid-cols-2 mx-3 md:mx-60 space-y-4 md:space-y-0 text-center gap-8'>
      ...
      <div>
        <h1 className='text-4xl font-bold text-center mt-16 mb-10'>Why You Should take <span className='text-blue-600'>GBNO?</span></h1>
        <div className='md:grid md:grid-cols-3 md:mx-20 space-y-4 md:space-y-0 mx-4 text-center gap-8'>
      ...
      <div>
        <h1 className='text-4xl font-bold text-center mt-16 mb-10'>GBNO <span className='text-blue-600'>Test</span> Highlights</h1>
        <div className='md:grid md:grid-cols-2 md:mx-96 mx-4 md:space-y-0 space-y-4 text-center gap-16'>
          <div className='border rounded-xl py-5'>
      ...
      <div>
        <h1 className='text-center text-4xl font-bold mt-16'>How to register for <span className='text-blue-600'>GBNO?</span></h1>
        <div className='md:grid md:grid-cols-3 md:space-y-0 space-y-3 mt-10'>
          <div>
      ...
      <div>
        <p className='text-center flex justify-center items-center md:space-x-4 space-x-2 bg-orange-100 py-4 mt-8 text-orange-500 font-semibold text-md'>Share and invite your friends to write GBNO !
        <a href=''><img src={facebook} className='md:h-10 h-8 md:pl-4 pl-2' alt='facebook logo'></img></a>
        <a href=''><img src={whatsapp} className='md:h-10 h-8' alt='whatssapp logo'></img></a>
        <a href=''><img src={instagram} className='md:h-10 h-8' alt='insta logo'></img></a>
        <a href=''><img src={twitter} className='md:h-10 h-8' alt='twitter logo'></img></a>
        <a href=''><img src={linkedin} className='md:h-10 h-8' alt='linkedin logo'></img></a>
        </p>
      </div>
