...
const Slide1 = () => {
  ...
  return (
    ...
    <div className='order-last'><img src={im1} alt='background' className='lg:h-[30rem] h-[14rem] mx-auto mt-6 lg:mt-0  lg:-ml-12 '></img></div>
      <div className='col-span-2'>
      <h1 className='text-white lg:text-6xl text-3xl font-bold italic lg:mt-12 mx-8 lg:ml-28  '>Gravity Brain helps your child </h1>   
       <p className='text-white lg:text-5xl text-xl mt-2 lg:mt-4 mx-8 lg:ml-28 italic'>train his mind to learn</p>
       <p className='text-white lg:mt-8 mt-4  lg:ml-28 mx-8 lg:text-xl text-lg'>To build critical thinking and aptitude through a 100% project based approach
