...
const Slide1 = () => {
  ...
  return (
    ...
    <div className='order-last'><img src={im1} alt='background' className='md:h-[30rem] h-[14rem] mx-auto mt-6 md:mt-0  md:-ml-12 '></img></div>
      <div className='col-span-2'>
      <h1 className='text-white md:text-6xl text-3xl font-bold italic md:mt-12 mx-8 md:ml-28  '>Gravity Brain helps your child </h1>   
       <p className='text-white md:text-5xl text-xl mt-2 md:mt-4 mx-8 md:ml-28 italic'>train his mind to learn</p>
       <p className='text-white md:mt-8 mt-4  md:ml-28 mx-8 md:text-xl text-lg'>To build critical thinking and aptitude through a 100% Project based approach
