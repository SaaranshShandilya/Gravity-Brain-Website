    ...
    <div>
        <Slider {...settings} className='mt-12'>
          <div className='text-center mx-auto'>
            ...
            <h1 className='text-white text-xl mx-4 font-semibold mt-2 pb-7'>Unleash the power of conceptualising, apply, evaluate, access & adapt</h1>
          </div>
          <div className='text-center mx-auto'>
            ...
            <h1 className='text-blue-600 text-3xl font-semibold mt-2'>a continuous thinker in making</h1>
            <h1 className='text-white text-xl mx-4 font-semibold mt-2 pb-7'>Projects on STEM Based topics help young mind understand concepts and practical applications of Science, Tech, Engg. & Math in real life.</h1>
          </div>
          <div className='text-center mx-auto'>
